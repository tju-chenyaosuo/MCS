...
def do_test(run_time_limit, program_queue, core_num):
    ...
    while time_spt < run_time_limit:
        ...
        conf_file = None
        program_id = None
        if main_configure_baseline.baseline_type == main_configure_baseline.baseline_types[0]:    # random
            program_id = 'random-' + str(program_num)
        if main_configure_baseline.baseline_type == main_configure_baseline.baseline_types[1]:    # default
            program_id = 'default-' + str(program_num)
        if main_configure_baseline.baseline_type == main_configure_baseline.baseline_types[2]:    # hicond
